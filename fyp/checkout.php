...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>city</span>
            <input type="text" placeholder="e.g. Shatin" name="city" required>
         </div>
         <div class="inputBox">
            <span>District/State</span>
            <input type="text" placeholder="e.g. Hong Kong Island" name="state" required>
         </div>
         <div class="inputBox">
            <span>country</span>
            <input type="text" placeholder="e.g. Hong Kong" name="country" required>
         </div>
         <div class="inputBox">
            <span>pin code</span>
            <input type="text" placeholder="e.g. 000000" name="pin_code" required>
         </div>
      </div>
